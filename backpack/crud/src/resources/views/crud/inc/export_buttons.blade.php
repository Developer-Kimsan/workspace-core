@if ($crud->exportButtons())
  ...
  <script src="{{ asset('packages/datatable.views/js/dataTables.buttons.min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('packages/datatable.views/js/buttons.bootstrap4.min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('packages/datatable.views/js/jszip.min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('packages/datatable.views/js/pdfmake.min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('packages/datatable.views/js/vfs_fonts.js') }}" type="text/javascript"></script>
  <script src="{{ asset('packages/datatable.views/js/buttons.html5.min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('packages/datatable.views/js/buttons.print.min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('packages/datatable.views/js/buttons.colVis.min.js') }}" type="text/javascript"></script>
  <script>
